            ...
            <v-flex>
              <v-card class="ma-5 text-center mt-12" shaped elevation="10">
                ...
                <v-card-title class="layout justify-center"
                  >Bes Wilis</v-card-title
                >
                <v-card-subtitle class="layout justify-center"
                  >24 year, California</v-card-subtitle
                >
                <v-list>
                  <v-list-item>
              ...
              <v-card class="ma-5 text-center mt-12" shaped elevation="10">
                <v-list-item three-line>
                  <v-list-item-content>
                    ...
                    <v-list-item-subtitle
                      >2345 4645 7865 5432</v-list-item-subtitle
                    >
                  </v-list-item-content>
              ...
              <v-card class="ma-5" shaped elevation="10">
                <v-list>
                  <v-list-item>
                    <v-list-item-avatar
                      ...
                      color="cyan darken-1"
                    ></v-list-item-avatar>
                    <v-list-item-title class="ml-n2">Darshan</v-list-item-title>
                    <v-list-item-subtitle>30% Attendence</v-list-item-subtitle>
                  </v-list-item>
                  <v-list-item>
                    <v-list-item-title class="cyan--text text--darken-1"
                      >MON</v-list-item-title
                  ...
                  <v-list-item class="mt-n5">
                    <v-list-item-subtitle
                      >Coming only 4 days in month</v-list-item-subtitle
                    >
                  </v-list-item>
                  <v-divider></v-divider>
                </v-list>
                <v-list two-line subheader>
                  <v-list-item>
                    ...
                    <v-list-item-content class="ml-n5">
                      <v-list-item-title>Darshan Gada</v-list-item-title>
                      <v-list-item-subtitle
                        >Swami Vivekanand High School</v-list-item-subtitle
                      >
                    </v-list-item-content>
                  </v-list-item>
                </v-list>
                <v-list two-line subheader class="mt-n5">
                  <v-list-item>
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle>Pass</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
                </v-list>
                <v-list two-line subheader class="mt-n8">
                  <v-list-item>
                    <v-list-item-title class="cyan--text text--darken-1"
                      >Marks</v-list-item-title
                    >
                    <v-list-item-title class="cyan--text text--darken-1"
                      >Percentage</v-list-item-title
                    >
                  </v-list-item>
                  <v-list-item class="mt-n10">
                    <v-list-item-title>397/500</v-list-item-title>
                    <v-list-item-title>79.80%</v-list-item-title>
                  </v-list-item>
                </v-list>
              </v-card>
            </v-flex>
          ...
          <v-container>
            <v-flex>
              <v-list class="mt-5">
                <v-list-item>
                  <v-list-item-title class="cyan--text text--darken-1"
                    >Examiniations</v-list-item-title
                  >
                  <v-list-item-action>
                    ...
                    <v-col cols="12" md="10">
                      <v-list two-line subheader class="ml-n8">
                        <v-list-item>
                          <v-list-item-content>
                            <v-list-item-subtitle
                              >21 Jul, 2019</v-list-item-subtitle
                            >
                            <v-list-item-title
                              >Hypertensive crisis</v-list-item-title
                            >
                            <v-list-item-subtitle
                              >Ongoing treatment</v-list-item-subtitle
                            >
                          </v-list-item-content>
                        </v-list-item>
                      </v-list>
                    ...
                    <v-col cols="12" md="10">
                      <v-list two-line subheader class="ml-n8">
                        <v-list-item>
                          <v-list-item-content>
                            <v-list-item-subtitle
                              >18 Jul, 2019</v-list-item-subtitle
                            >
                            <v-list-item-title>Osteoporosis</v-list-item-title>
                            <v-list-item-subtitle
                              >Incurable</v-list-item-subtitle
                            >
                          </v-list-item-content>
                        </v-list-item>
                      </v-list>
                      ...
                      <v-list two-line subheader class="ml-n8">
                        <v-list-item>
                          <v-list-item-content>
                            ...
                            >
                            <v-list-item-subtitle
                              >Examiniations</v-list-item-subtitle
                            >
                          </v-list-item-content>
                        </v-list-item>
                      </v-list>
            ...
            <v-flex>
              <v-list class="mt-5">
                <v-list-item>
                  <v-list-item-title class="cyan--text text--darken-1"
                    >Health Curve</v-list-item-title
                  >
                  <v-item-content>
            ...
            <v-flex>
              <v-list class="ml-5">
                <v-list-item>
                  <v-list-item-title class="cyan--text text--darken-1"
                    >Nearest Treatment</v-list-item-title
                  >
                  <v-list-item-title class="cyan--text text--darken-1"
                    >Advice</v-list-item-title
                  >
                </v-list-item>
              </v-list>
            </v-flex>
              ...
              <v-row>
                ...
                <div class="ml-10">
                  <v-list>
                    <v-list-item>
                      <v-list-item-title
                        >The Clinical service is consulted and available on a
                        24-Houre</v-list-item-title
                      >
                    </v-list-item>
                  </v-list>
                </div>
